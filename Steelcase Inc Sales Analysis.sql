...
/*1 Which state contributes the most to the company's overall sales?*/
SELECT TOP 1
	c.State,
...
/*Que-2 Calculate the percentage distribution of each subcategory sales to the total sales in various region.*/
SELECT 
	c.Region,
	p.Sub_Category,
...
/*3 What is the total sales for each product category in each region?*/
SELECT 
	c.Region,
	p.Category,
	SUM( s.Sales) AS Total_Sales 
